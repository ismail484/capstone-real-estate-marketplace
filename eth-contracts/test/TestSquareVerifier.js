...
// - using the contents from proof.json generated from zokrates steps
const proof = require('../../zokrates/code/square/proof')

contract('TestVerifier', accounts => {
  const account_one = accounts[0]

  // Test case for verification with correct proof
  describe('Verification with correct proof', function () {
    ...
    // Test case for  verification with incorrect proof
    it('Verification with incorrect proof', async function () {
      ...
      assert.equal(
        verified,
        false,
        'Verification must fail with incorrect proof'
      )
    })
  })
})